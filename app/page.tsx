...
export default function Home() {
  const services = [
    ...
    {
      title: 'AI Solutions',
      description: 'Cutting-edge artificial intelligence and machine learning solutions to automate and optimize your processes.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Codecrafters Solutions is your global partner for innovative software development, 
                web design, mobile app creation, and cutting-edge AI solutions. We help businesses 
                establish a strong online presence and achieve their digital transformation goals.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                With a blend of technical expertise, creative vision, and a commitment to client success, 
                we craft solutions that are tailored, scalable, and future-ready.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Cutting-edge technology and innovation</span>
                </div>
              </div>
              <div className="mt-8">
                <Link
                ...
                <div className="bg-white p-6 rounded-xl">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-gray-700">Admin@codecrafters.world</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
