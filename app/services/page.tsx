...
export default function Services() {
  const services = [
    {
      ...
      description: 'We build robust, scalable, and innovative software solutions tailored to your specific business needs.',
      icon: (
    ...
    },
    {
      ...
      description: 'We create stunning, user-friendly websites that engage your audience and drive conversions.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'We leverage cutting-edge AI and machine learning to automate and optimize your business processes.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      technologies: ['TensorFlow', 'PyTorch', 'OpenAI', 'Azure AI', 'AWS ML', 'Python'],
      benefits: [
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'Our design team creates wireframes, mockups, and prototypes to visualize the solution before development begins.',
    },
    {
      step: '03',
    ...
    },
    {
      ...
      description: 'We deploy your solution and provide ongoing support, maintenance, and updates to ensure optimal performance.',
    },
  ];
      ...
      <section className="bg-gradient-to-br from-black via-gray-900 to-black text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            From custom software development to cutting-edge AI solutions, we've got you covered.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive range of services is designed to meet all your digital transformation needs.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <p className="text-orange-500 font-medium mb-4">{service.subtitle}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover how our services can transform your business and drive growth.
            </p>
          </div>
              ...
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-xl">
                    <h4 className="text-white text-xl font-semibold mb-4">Why Choose This Service?</h4>
